...
Remove-Item -LiteralPath (Join-Path $target "runtime-config.js") -ErrorAction SilentlyContinue
Remove-Item -LiteralPath (Join-Path $target "web-build.json") -ErrorAction SilentlyContinue
