...
Assert-Contains -Label "publish_android.ps1" -Text $script -Needle "server\cmd\wheelmaker-desktop\bootstrap\index.html"
Assert-Contains -Label "publish_android.ps1" -Text $script -Needle "app\src\main\assets\bootstrap\index.html"
...
Assert-NotContains -Label "publish_android.ps1" -Text $script -Needle "WebRoot"
