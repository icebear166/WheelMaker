...
const (
	...
	ACPProviderCXFlicker  ACPProvider = "cx-flicker"
...
func ParseACPProvider(name string) (ACPProvider, bool) {
	...
	case string(ACPProviderCXFlicker):
		return ACPProviderCXFlicker, true
