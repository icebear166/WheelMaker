...
- [ ] **Step 2: Run command tests to establish RED**
...
- [ ] **Step 3: Unify command candidate handling**
...
- [ ] **Step 4: Run command tests to reach GREEN**

Run: `go test ./cmd/wheelmaker-gateway -run 'TestRunValidate|TestRunRender|TestRunPaths'`

Expected: PASS.

- [ ] **Step 5: Add failing runtime state-transition tests**
...
- [ ] **Step 6: Run runtime tests to establish RED**
...
- [ ] **Step 7: Implement atomic runtime acceptance**
...
- [ ] **Step 8: Run runtime and CLI regressions**
