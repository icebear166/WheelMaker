...
- Create: `docs/scope/2026-07-28-flicker-v2-request-parity.md`
- Create: `docs/plans/2026-07-28-flicker-v2-request-parity/plan-flicker-v2-request-parity.md`
...
```powershell
rg -n "TB[D]|TO[D]O|implement lat[e]r" docs/scope/2026-07-28-flicker-v2-request-parity.md
git diff --check
git status --short
```
