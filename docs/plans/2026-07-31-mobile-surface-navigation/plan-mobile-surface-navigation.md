...
**Files:**
- Create: `docs/scope/2026-07-31-mobile-surface-navigation.md`
- Create: `docs/plans/2026-07-31-mobile-surface-navigation/plan-mobile-surface-navigation.md`
...
```powershell
rg -n "T[B]D|T[O]DO|i[m]plement later|f[i]ll in details" docs/scope/2026-07-31-mobile-surface-navigation.md docs/wiki/frontend-interaction
git diff --check
```
...
```powershell
git add docs/scope/2026-07-31-mobile-surface-navigation.md docs/wiki/frontend-interaction/mobile-floating-nav.md docs/wiki/frontend-interaction/workbench-chrome.md docs/wiki/frontend-interaction/frontend-interaction.md
