...
- Add: `docs/scope/2026-07-14-server-data-settings.md`
- Add: `docs/plans/2026-07-14-server-data-settings/plan-server-data-settings.md`
...
rg -n ($terms -join '|') docs/scope/2026-07-14-server-data-settings.md
git diff --check -- docs/scope/2026-07-14-server-data-settings.md
```
...
```powershell
git add docs/scope/2026-07-14-server-data-settings.md
