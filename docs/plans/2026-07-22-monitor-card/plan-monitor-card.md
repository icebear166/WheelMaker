...
**Files:**
- Modify: `docs/plans/2026-07-22-monitor-card/plan-monitor-card.md`
- Verify: `docs/scope/2026-07-22-monitor-card.md`
...
```powershell
rg -n "TB[D]|TO[D]O|implement lat[e]r" docs/scope/2026-07-22-monitor-card.md docs/wiki/features/limits-monitoring.md docs/wiki/features/model-efficiency.md
git diff --check
git status --short
```
