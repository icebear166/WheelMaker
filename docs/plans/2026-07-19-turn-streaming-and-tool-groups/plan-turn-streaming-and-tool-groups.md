...
**Files:**
- Create: `docs/scope/2026-07-19-turn-streaming-and-tool-groups.md`
- Create: `docs/plans/2026-07-19-turn-streaming-and-tool-groups/plan-turn-streaming-and-tool-groups.md`
...
```powershell
git diff --check -- docs/scope/2026-07-19-turn-streaming-and-tool-groups.md docs/wiki/frontend-interaction docs/wiki/architecture/session-management-and-sync.md
```
...
```powershell
git add docs/scope/2026-07-19-turn-streaming-and-tool-groups.md docs/wiki/frontend-interaction docs/wiki/architecture/session-management-and-sync.md
...
**Files:**
- Modify: `docs/plans/2026-07-19-turn-streaming-and-tool-groups/plan-turn-streaming-and-tool-groups.md` (mark completed checkboxes)
