...
- 目标规格是 `docs/scope/2026-07-13-system-security-baseline.md`；已删除的旧 `docs/plans/nospec/2026-07-13-security-hardening/plan-security-hardening.md` 不得继续执行。
