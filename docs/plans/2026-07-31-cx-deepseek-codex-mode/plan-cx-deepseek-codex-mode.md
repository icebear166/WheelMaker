...
- Product contract: [`spec-cx-deepseek-codex-mode.md`](../../scope/2026-07-31-cx-deepseek-codex-mode.md).
...
**Files:**
- Modify: `docs/plans/2026-07-31-cx-deepseek-codex-mode/plan-cx-deepseek-codex-mode.md` — mark executed checkboxes complete.
