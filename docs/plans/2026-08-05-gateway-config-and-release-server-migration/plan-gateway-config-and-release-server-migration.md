...
**Files:**
- Create: `docs/scope/2026-08-05-gateway-config-and-release-server-migration.md`
- Create: `docs/plans/2026-08-05-gateway-config-and-release-server-migration/plan-gateway-config-and-release-server-migration.md`
...
rg -n ($placeholderPatterns -join '|') docs/scope/2026-08-05-gateway-config-and-release-server-migration.md docs/wiki/architecture/gateway.md docs/wiki/release-and-build/release.md
```
...
```powershell
git diff --check
git add docs/scope/2026-08-05-gateway-config-and-release-server-migration.md docs/wiki/architecture/gateway.md docs/wiki/release-and-build/release.md
