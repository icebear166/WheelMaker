...
- Create: `docs/scope/2026-07-24-topbar-menu-unification.md`
- Create: `docs/plans/2026-07-24-topbar-menu-unification/plan-topbar-menu-unification.md`
...
- [ ] **Step 4: Commit the approved scope and wiki records with the finished implementation.**
  ...
  ```powershell
  git add docs/scope/2026-07-24-topbar-menu-unification.md docs/wiki/frontend-interaction/visual-language.md docs/wiki/frontend-interaction/pc-chat-sidebar-modes.md
