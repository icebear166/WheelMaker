...
**Source spec:** `docs/scope/2026-07-28-file-context-menu-actions.md`
...
- Keep `docs/scope/2026-07-28-file-context-menu-actions.md`, `docs/plans/2026-07-28-file-context-menu-actions/plan-file-context-menu-actions.md`, and `docs/wiki/features/file-links.md` as the approved design and durable behavior record.

### Task 1: Commit the approved scope and wiki artifacts

**Files:**

- Create: `docs/scope/2026-07-28-file-context-menu-actions.md`
- Create: `docs/plans/2026-07-28-file-context-menu-actions/plan-file-context-menu-actions.md`
...
```powershell
$spec = 'docs/scope/2026-07-28-file-context-menu-actions.md'
$plan = 'docs/plans/2026-07-28-file-context-menu-actions/plan-file-context-menu-actions.md'
...
```powershell
git add docs/scope/2026-07-28-file-context-menu-actions.md docs/wiki/features/file-links.md
