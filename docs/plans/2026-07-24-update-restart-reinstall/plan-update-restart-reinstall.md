...
**Spec:** [spec-update-restart-reinstall.md](../../scope/2026-07-24-update-restart-reinstall.md)
...
Confirm against [spec-update-restart-reinstall.md](../../scope/2026-07-24-update-restart-reinstall.md): hub Restart on up_to_date (Task 4), all packages uninstallable (Task 1), reinstall = uninstall→install (Task 1), npm operation matrix (Task 4), no backend update.go change (verified — Task 1 only touches npm.go).
