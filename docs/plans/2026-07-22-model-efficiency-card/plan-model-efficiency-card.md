...
```powershell
git add app/web/src/app app/web/src/settings app/web/src/storage app/__tests__ docs/scope/2026-07-22-model-efficiency-card.md docs/wiki
...
```powershell
git diff --check
rg -n -i "TBD|TODO|implement later|fill in details" docs/scope/2026-07-22-model-efficiency-card.md app/web/src/modelEfficiency
git status --short
