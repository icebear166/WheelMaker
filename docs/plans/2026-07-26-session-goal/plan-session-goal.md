...
**Files:**
- Modify: `docs/plans/2026-07-26-session-goal/plan-session-goal.md`
- Verify: `docs/scope/2026-07-26-session-goal.md`
...
```powershell
rg -n "T[B]D|T[O]DO|implement[ ]later|fill[ ]in[ ]details" docs/scope/2026-07-26-session-goal.md docs/wiki/agents
