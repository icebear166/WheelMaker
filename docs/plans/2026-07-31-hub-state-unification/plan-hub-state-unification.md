...
**Files:**
- Modify: `docs/scope/2026-07-31-hub-state-unification.md` only if implementation reveals an approved-contract clarification
...
```powershell
git diff --check
rg -n 'T[B]D|T[O]DO|implement[ ]later' docs/scope/2026-07-31-hub-state-unification.md docs/wiki/architecture/hub-state.md docs/wiki/protocols/registry.md docs/wiki/frontend-interaction/hub-menu.md
git status --short
```
