...
**Files:**
- Verify: `docs/scope/2026-07-30-unified-app-menu.md`
- Verify: `docs/plans/2026-07-30-unified-app-menu/plan-unified-app-menu.md`
...
```powershell
git add docs/scope/2026-07-30-unified-app-menu.md docs/wiki/frontend-interaction/app-menu.md docs/wiki/frontend-interaction/frontend-interaction.md docs/wiki/release-and-build/desktop-self-update.md
