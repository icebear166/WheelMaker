...
**Files:**
- Verify: `docs/scope/2026-07-18-desktop-self-update.md`
...
In `docs/plans/2026-07-18-desktop-self-update/plan-desktop-self-update.md`, change each completed step marker from `- [ ]` to `- [x]`, then run:

```powershell
rg -n "^- \[ \]" docs/plans/2026-07-18-desktop-self-update/plan-desktop-self-update.md
git status --short
git diff --check
```
