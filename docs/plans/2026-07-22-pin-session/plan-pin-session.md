...
参考 spec：`docs/scope/2026-07-22-pin-session.md`
...
**Files:**
- Add: `docs/scope/2026-07-22-pin-session.md`
- Add: `docs/plans/2026-07-22-pin-session/plan-pin-session.md`
...
```powershell
rg -n "session\.pin|session_sync_json|Recent|移动端|2\.6" docs/scope/2026-07-22-pin-session.md docs/wiki/frontend-interaction/session-list.md
...
```powershell
rg -n "TODO|TBD|待定|placeholder|<fill-me>" docs/scope/2026-07-22-pin-session.md docs/wiki/frontend-interaction/session-list.md
git diff --check
```
...
```powershell
git add docs/scope/2026-07-22-pin-session.md docs/wiki/frontend-interaction/frontend-interaction.md docs/wiki/frontend-interaction/session-list.md
...
**Files:**
- Modify: `docs/plans/2026-07-22-pin-session/plan-pin-session.md`（勾选实际完成项并记录任何与计划不同但已验证的实现）
