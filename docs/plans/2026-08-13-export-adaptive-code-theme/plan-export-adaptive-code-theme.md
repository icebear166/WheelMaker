...
- [x] **Step 1: 读取两页全文，定位导出/渲染边界相关章节**

- [x] **Step 2: file-links.md 的 Markdown HTML 导出章节补一句双主题边界；chat-sharing.md 的文档渲染/快照章节补同口径一句**
...
- [x] **Step 3: 逐项核对 spec 验收并记录证据**

- [x] **Step 4: git-workflow finalize（complete）**
