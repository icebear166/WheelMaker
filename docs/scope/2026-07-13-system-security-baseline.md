...
本规格是全系统安全总规格，记录已经落地的基线、仍属过渡状态的实现和最终目标。实施必须在本规格批准后拆成可独立验证和回滚的分阶段计划，旧的 `docs/plans/nospec/2026-07-13-security-hardening/plan-security-hardening.md` 不再作为目标状态的依据。
