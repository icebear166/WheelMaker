...
- Create: `docs/scope/2026-07-24-markdown-html-export/plan-markdown-html-export.md`
- Modify: `docs/scope/2026-07-24-markdown-html-export/spec-markdown-html-export.md`
- Modify: `docs/wiki/features/file-links.md`

- [ ] **Step 1: Inspect the approved documents**

Run: `git status --short && git diff -- docs/scope/2026-07-24-markdown-html-export docs/wiki/features/file-links.md`
...
```powershell
git add docs/scope/2026-07-24-markdown-html-export docs/wiki/features/file-links.md
