...
- Keep `docs/scope/2026-07-28-token-usage-curve/spec-token-usage-curve.md` as the accepted source.
...
**Files:**
- Modify if implementation differs: `docs/scope/2026-07-28-token-usage-curve/spec-token-usage-curve.md`
- Modify if stable behavior differs: `docs/wiki/features/limits-monitoring.md`
- Update checklist: `docs/scope/2026-07-28-token-usage-curve/plan-token-usage-curve.md`
...
```powershell
rg -n -i 'TBD|TODO|implement later' docs/scope/2026-07-28-token-usage-curve/spec-token-usage-curve.md docs/wiki/features/limits-monitoring.md
git diff --check
git status --short
```
