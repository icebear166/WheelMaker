...
- Modify the superseded `docs/scope/2026-08-05-*/spec-*.md` files that assert selector/static-root/`gateway-update` behavior: add a historical-status banner linking to the new specification.
...
- Modify: relevant `docs/scope/2026-08-05-*/spec-*.md`
