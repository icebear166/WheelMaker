...
- Add: `docs/scope/2026-07-19-debug-web-registry-transfer/spec-debug-web-registry-transfer.md`
- Add: `docs/scope/2026-07-19-debug-web-registry-transfer/plan-debug-web-registry-transfer.md`
...
```bash
git add docs/wiki/protocols/registry.md docs/wiki/release-and-build/release.md docs/scope/2026-07-19-debug-web-registry-transfer
