...
**Files:**
- Add: `docs/scope/2026-07-24-external-file-links/spec-external-file-links.md`
...
```powershell
rg -n "project\.fs\.external\.(info|read)|Copy relative path|Open with VS Code" docs/scope/2026-07-24-external-file-links docs/wiki/features/file-links.md docs/wiki/protocols/registry.md
git add docs/scope/2026-07-24-external-file-links/spec-external-file-links.md docs/scope/2026-07-24-external-file-links/plan-external-file-links.md docs/wiki/features/file-links.md docs/wiki/features/features.md docs/wiki/protocols/registry.md
