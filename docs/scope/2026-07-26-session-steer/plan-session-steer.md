...
```powershell
git add docs/scope/2026-07-26-session-steer server/internal/protocol/session_actions.go server/internal/protocol/acp.go server/internal/protocol/registry_methods.go server/internal/protocol/registry_methods_test.go server/internal/hub/agent/factory.go server/internal/hub/agent/agent_test.go server/internal/hub/reporter.go server/internal/hub/hub_test.go
...
- Verify: `docs/scope/2026-07-26-session-steer/spec-session-steer.md`
