...
- Add: `docs/scope/2026-07-27-desktop-script-updater/spec-desktop-script-updater.md`
- Add: `docs/scope/2026-07-27-desktop-script-updater/plan-desktop-script-updater.md`
...
```powershell
Get-Content -Raw docs/scope/2026-07-27-desktop-script-updater/spec-desktop-script-updater.md
Get-Content -Raw docs/scope/2026-07-27-desktop-script-updater/plan-desktop-script-updater.md
```
...
```powershell
git diff --check -- docs/scope/2026-07-27-desktop-script-updater docs/wiki/release-and-build
git diff -- docs/scope/2026-07-27-desktop-script-updater docs/wiki/release-and-build
```
...
```powershell
git add docs/scope/2026-07-27-desktop-script-updater/spec-desktop-script-updater.md docs/scope/2026-07-27-desktop-script-updater/plan-desktop-script-updater.md docs/wiki/release-and-build/desktop-self-update.md docs/wiki/release-and-build/build.md docs/wiki/release-and-build/release.md
