...
- Modify after successful rollout: `docs/scope/2026-07-17-self-hosted-release-server/spec-self-hosted-release-server.md` only if a verified production fact differs from the approved spec
